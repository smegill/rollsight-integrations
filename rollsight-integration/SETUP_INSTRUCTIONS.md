...
6. New roll requests receive dice automatically. If several requests are open, the newest receives first. Older requests resume when it closes. Foundry’s normal manual entry and close controls remain available.
